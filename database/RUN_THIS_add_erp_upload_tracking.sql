-- Aviation QC App - Add ERP Upload Tracking
-- This script is SAFE to run multiple times (idempotent)

-- Add ERP upload tracking columns to photo_batches table
...
DO $$
BEGIN
    RAISE NOTICE '✅ ERP upload tracking has been successfully added to photo_batches table';
END $$;